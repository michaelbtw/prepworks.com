...
<script>
	...
	//	jQuery( ".payment_method_authorize_net_cim_credit_card #icon-div" ).prepend( '<img src="https://www.jjlawnserviceinc.com/wp-content/uploads/2014/02/Authorize_Logo.gif">' );
	//});
</script>
