    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9" id="thecopy">
                <?php
                $loop = new WP_Query(array('post_type' => 'geolocation', 'order_by' => 'menu_order', 'order' => 'asc', 'posts_per_page' => 1));
...
?>
            ...
            <div class="col-md-3" id="thebutton">
                <?php
                $loop = new WP_Query(array('post_type' => 'geolocation', 'order_by' => 'menu_order', 'order' => 'asc', 'posts_per_page' => 1, 'offset' => 1));
                while ($loop->have_posts()) : $loop->the_post();
                    ?>
    <?php the_content(); ?>
...
<div class="container">
    <div class="row">
        <div class="col-md-12" id="featured-home">
            ...
            <?php
            $loop = new WP_Query(array('post_type' => 'featured', 'order_by' => 'menu_order', 'order' => 'asc', 'posts_per_page' => -1));
            while ($loop->have_posts()) : $loop->the_post();
                ?>
